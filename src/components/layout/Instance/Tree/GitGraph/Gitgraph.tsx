...
interface GitgraphPropsWithChildren {
  onCommitDoubleClick?: (commit: CommitCore<ReactSvgElement>) => void;
  pointer?: string;
...
class Gitgraph extends React.Component<GitgraphProps, GitgraphState> {
  ...
  constructor(props: GitgraphProps) {
    ...
    this.gitgraph.subscribe((data) => {
      ...
      this.setState({
        ...parseCommits(commits, branchesPaths),
        commitMessagesX,
        shouldRecomputeOffsets: true,
      });
    });
          ...
          <g ref={this.$commits}>
            {this.state.commits.map((commit) => (
              <Commit
                ...
                selected={this.props.pointer === commit.hash}
                onDoubleClick={this.props.onCommitDoubleClick}
              />
            ))}
          </g>
